...
def main():
    ...
    def load_data():
        data = pd.read_csv("C:/Users/anmol/Documents/Streamlit ML Models/mushrooms.csv")
        label = LabelEncoder()
    ...
    classfier = st.sidebar.selectbox("Classifier", ('Support Vector Machines (SVM)', 'Logistic Regression', 'Random Forest'))

    if classfier == 'Support Vector Machines (SVM)':
    ...
    if classfier == 'Logistic Regression':
        ...
        if st.sidebar.button("Classify", key='classify'):
            st.subheader("Logistic Regresssion Results")
